...
<head>
    ...
    <title>Khulna</title>
    <link rel="stylesheet" href="khulna.css">
...
header{
    width: 100%;
    height: 65px;
    background:linear-gradient(160deg,rgb(255, 0, 0),rgb(131, 3, 182)) ;
    display: flex;
    ...
    <header>
        ...
        <div class="serch">
            ...
            <button title="search"><a href="#"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEU
                ...
                OIa3CB+E0WKdhwpDSeGJv9HEBycg1zEdsQ0W4mU/oQlA5AqThaKm5fmcbhoQ+cal
